  ...
  return (
    <section
      ...
      className="
        ...
        pt-20 pb-12 px-6 md:px-12 lg:px-16
        bg-black
        overflow-hidden
      "
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
        ...
        <div className="relative w-full lg:w-[60%] flex flex-col items-center lg:items-start text-center lg:text-left space-y-4 order-2 lg:order-1">
          ...
          <div className="flex flex-col items-center lg:items-start gap-8 pt-4">
            ...
            {/* BUTTONS (ADDED DOWNLOAD BUTTON) */}
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <button className="group relative px-10 py-5 bg-white text-black font-bold rounded-xl overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-2xl">
              ...
              <button
                className="
                px-10 py-5 rounded-xl font-bold
...
/* SOCIAL ICON (UPDATED HOVER COLOR ONLY) */
